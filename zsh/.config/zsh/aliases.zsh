...
alias scheduler-preprod='scheduler-cli -H "scheduler-preprod.vm.strln.net" --key "$(get-token)"'
...
alias sl-aws-preprod='sl aws session generate --account-id "065148239691" --role-name "owner" --profile "slvm_preprod"'
